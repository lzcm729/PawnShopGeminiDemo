...
export const ALL_NEWS_DATA: NewsItem[] = [
    ...
    },
    {
        ...
        duration: 2,
        triggers: [
            { variable: "chain_emma.stage", operator: "==", value: 99 }, // Completed Good Ending
    ...
    // --- LIN STORYLINE ---
    {
        ...
        category: NewsCategory.MARKET, // Hybrid Narrative/Market
        priority: 70,
        duration: 2,
        triggers: [
...

    {
        ...
        triggers: [
            ...
            { variable: "day", operator: "%", value: 7 } // Weekly risk
        ],
        effect: {
            categoryTarget: "All",
            priceMultiplier: 1.0, 
...

    {
        ...
        effect: {
            actionPointsModifier: -2 // Debuff: Rain makes you tired
        }
    },
    {
        ...
        effect: {
            categoryTarget: "奢侈品",
            priceMultiplier: 1.1, // Slight Buff
            actionPointsModifier: 2 // Happy mood
        }
    },
    {
