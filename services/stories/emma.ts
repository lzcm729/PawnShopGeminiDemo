...
export const EMMA_EVENTS: StoryEvent[] = [
  ...
  },
  {
    ...
    triggerConditions: [
      ...
      // Check hope level to ensure she hasn't given up
      { variable: "hope", operator: ">=", value: 40 }
    ],
    targetItemId: "emma_item_laptop",
    failureMailId: "mail_emma_plea", 
    // Reduce hope on failure so she eventually stops spamming mail
  ...
  },
  {
    ...
    template: {
      ...
      dialogue: { 
          ...
          rejected: "连你也嫌弃它晦气吗？", 
          rejectionLines: { standard: "好吧，打扰了。", angry: "这就是你们所谓的生意？", desperate: "求你了，我真的没地方去了..." } 
      },
