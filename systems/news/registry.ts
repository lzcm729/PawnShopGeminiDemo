...
export const ALL_NEWS_DATA: NewsItem[] = [
    ...
    // --- SUSAN STORYLINE ---
    {
        ...
        duration: 2,
        sourceLabel: "[警方通报]",
        tags: ["susan", "negative", "gambling"],
        effects: [],
        triggers: [
            { variable: "chain_susan.stage", operator: ">=", value: 1 }
        ],
        relatedChainId: "susan"
    },
    {
    ...
    // --- LIN STORYLINE ---
    {
        ...
        duration: 2,
        sourceLabel: "[科技前沿]",
        tags: ["lin", "electronics", "market"],
        effects: [
            { targetSystem: 'appraisal', parameter: 'electronics_price', modifier: -40, modifierType: 'PERCENTAGE', duration: 2 }
        ],
        triggers: [
...

    {
        ...
        duration: 3,
        sourceLabel: "[治安整顿]",
        tags: ["police", "crackdown", "risk"],
        effects: [
            { targetSystem: 'negotiation', parameter: 'stolen_risk', modifier: 15, modifierType: 'ABSOLUTE', duration: 3 }
        ],
        triggers: [
    ...
    },
    {
        ...
        duration: 2,
        sourceLabel: "[市场监管]",
        tags: ["investigation", "penalty", "credibility"],
        effects: [
            { targetSystem: 'negotiation', parameter: 'stolen_risk', modifier: 20, modifierType: 'ABSOLUTE', duration: 2 }
        ],
        triggers: [],
        effect: {
            riskModifier: 20
    ...
    },
    {
        ...
        duration: 2,
        sourceLabel: "[时尚风向]",
        tags: ["luxury", "price_up"],
        effects: [
            { targetSystem: 'appraisal', parameter: 'luxury_price', modifier: 30, modifierType: 'PERCENTAGE', duration: 2 }
        ],
        triggers: [
    ...
    },
    {
        ...
        duration: 2,
        sourceLabel: "[财经快讯]",
        tags: ["gold", "jewelry", "price_up"],
        effects: [
            { targetSystem: 'appraisal', parameter: 'jewelry_price', modifier: 25, modifierType: 'PERCENTAGE', duration: 2 }
        ],
        triggers: [
    ...
    },
    {
        ...
        duration: 3,
        sourceLabel: "[产业新闻]",
        tags: ["electronics", "price_down"],
        effects: [
            { targetSystem: 'appraisal', parameter: 'electronics_price', modifier: -30, modifierType: 'PERCENTAGE', duration: 3 }
        ],
        triggers: [
    ...
    },
    {
        ...
        duration: 2,
        sourceLabel: "[收藏警示]",
        tags: ["antique", "fake", "risk"],
        effects: [
            { targetSystem: 'appraisal', parameter: 'antique_price', modifier: -20, modifierType: 'PERCENTAGE', duration: 2 },
            { targetSystem: 'appraisal', parameter: 'antique_fake_risk', modifier: 10, modifierType: 'ABSOLUTE', duration: 2 }
        ],
        triggers: [
...

    {
        ...
        tags: ["weather", "debuff"],
        effects: [
            { targetSystem: 'player', parameter: 'action_points', modifier: -2, modifierType: 'ABSOLUTE', duration: 1 }
        ],
        triggers: [
             { variable: "day", operator: "%", value: 3 }
        ],
    ...
    },
    {
        ...
        tags: ["holiday", "buff"],
        effects: [
            { targetSystem: 'appraisal', parameter: 'luxury_price', modifier: 10, modifierType: 'PERCENTAGE', duration: 1 },
            { targetSystem: 'player', parameter: 'action_points', modifier: 2, modifierType: 'ABSOLUTE', duration: 1 }
        ],
        triggers: [
             { variable: "day", operator: "==", value: 5 },
    ...
    },
    {
        ...
        duration: 1,
        sourceLabel: "[市政公告]",
        tags: ["infrastructure", "debuff"],
        effects: [
            { targetSystem: 'player', parameter: 'action_points', modifier: -1, modifierType: 'ABSOLUTE', duration: 1 }
        ],
        triggers: [
            { variable: "day", operator: "%", value: 4 }
        ],
    ...
    // =========================================================================
    // VIOLATION CONSEQUENCE NEWS (generated dynamically, templates here)
    // =========================================================================

    {
        id: "news_violation_low",
        headline: "市场监管：抽查商户资质",
        body: "市场监督管理局对第12区多家商铺进行例行抽查，重点检查物品来源凭证。部分商家因手续不齐被要求限期整改。",
        category: NewsCategory.NARRATIVE_ECHO,
        priority: 60,
        duration: 1,
        sourceLabel: "[市场监管]",
    ...
    {
        id: "news_violation_medium",
        headline: "市场监管：典当行被约谈",
        body: "一家位于第12区的典当行因涉嫌收购可疑物品被监管部门约谈。该行暂停部分业务配合调查。社区居民对此议论纷纷。",
        category: NewsCategory.NARRATIVE_ECHO,
        priority: 80,
        duration: 2,
        sourceLabel: "[市场监管]",
        tags: ["violation", "medium"],
        effects: [
            { targetSystem: 'negotiation', parameter: 'stolen_risk', modifier: 10, modifierType: 'ABSOLUTE', duration: 2 }
        ],
        triggers: []
    },
    {
        id: "news_violation_high",
        headline: "市场监管：典当行被立案调查",
        body: "市场监督管理局通报，一家位于第12区的典当行因涉嫌收购来源不明物品被立案调查。知情人士透露，该店老板可能面临吊销执照的风险。",
        category: NewsCategory.NARRATIVE_ECHO,
        priority: 95,
        duration: 2,
        sourceLabel: "[市场监管]",
        tags: ["violation", "high", "investigation"],
        effects: [
            { targetSystem: 'negotiation', parameter: 'stolen_risk', modifier: 20, modifierType: 'ABSOLUTE', duration: 2 }
        ],
        triggers: []
