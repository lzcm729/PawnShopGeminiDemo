...
GIFT_RECEIVED,ARTISTIC,*,*,eager,1,"别人送的，我用不上，换点钱更实在。",
...
BREAKUP,ARTISTIC,*,young,eager,1,"前任的，留着膈应。",酒类|文房
HOBBY_QUIT,MECHANICAL|ARTISTIC,*,middle|elderly,calm,1,"以前的爱好，现在没时间玩了。",
UPGRADE,ARTISTIC|MECHANICAL,decent|fancy,*,calm,1,"换新的了，旧的处理掉。",
GENERIC,*,*,*,*,0.5,"就是想换点钱。",
