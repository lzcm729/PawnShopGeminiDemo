...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const baseStyles = "relative inline-flex items-center justify-center font-mono font-bold tracking-wider transition-all duration-200 disabled:opacity-50 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-noir-accent focus-visible:ring-offset-2 focus-visible:ring-offset-noir-100 hover:scale-[1.02]";
