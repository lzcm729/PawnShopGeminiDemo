...
import React from 'react';
    ...
    import { DollarSign, Calendar, Heart, Briefcase, Skull, Package, AlertOctagon, Mail, Bug } from 'lucide-react';
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="h-8 w-px bg-stone-700 mx-2"></div>
             ...
             <button
               ...
               className={`w-8 h-8 rounded flex items-center justify-center transition-all ${state.showDebug ? 'text-green-500 bg-green-900/20' : 'text-stone-600 hover:text-stone-400'}`}
